...
export function timespanFromUnixTimes (fromTime, toTime, unit) {
...
export function timespanFromUnixTimesShort(fromTime, toTime) {
  return timespanFromUnixTimes(fromTime, toTime, 'short')
}
