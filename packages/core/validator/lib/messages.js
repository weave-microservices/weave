module.exports = {
  ...
  stringUuid: 'The parameter "{param}" must be a valid UUID.',
  stringPhone: 'The parameter "{param}" must be a valid phone number.',
  stringHex: 'The parameter "{param}" must be a valid hexadecimal string.',
  stringPattern: 'The parameter "{param}" must match the pattern "{expected}".',
