...
describe('Type "multi" test', () => {
  ...
  it('should call custom validator', () => {
    ...
    assert.equal(JSON.stringify(result3), '[{"type":"string","message":"The parameter \\"id\\" have to be a string.","field":"id","passed":222},{"type":"array","message":"The parameter \\"id\\" have to be an array.","field":"id"}]');
  });
});
