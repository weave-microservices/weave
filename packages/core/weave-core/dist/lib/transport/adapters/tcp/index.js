...
const index_1 = __importDefault(require("./discovery/index"));
const message_types_1 = __importDefault(require("../../message-types"));
const tcpReader_1 = __importDefault(require("./tcpReader"));
const tcpWriter_1 = __importDefault(require("./tcpWriter"));
...
module.exports = function SwimTransport(adapterOptions) {
    ...
    const self = adapter_base_1.default(adapterOptions);
    let tcpReader;
    let tcpWriter;
    let gossipTimer;
    self.afterInit = function () {
        ...
        self.swim = index_1.default(self, adapterOptions);
    };
    ...
    function startTCPServer() {
        tcpReader = tcpReader_1.default(self, adapterOptions);
        tcpWriter = tcpWriter_1.default(self, adapterOptions);
