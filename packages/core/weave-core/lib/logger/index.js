...
function createDefaultLogger(options, bindings) {
    ...
    options.types = mergeTypes(types_1.defaultTypes, customTypes);
    // process log types
    ...
    const formatMessage = args => {
        args = arrayify(args);
        return util_1.default.formatWithOptions({ colors: true, compact: 1, breakLength: Infinity }, args[0], ...args.splice(0, 1));
    };
