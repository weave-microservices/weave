import { ServiceSchema } from '../registry/service'
const { clone, compact, deepMerge, defaultsDeep, flatten, wrapHandler, wrapInArray } = require('@weave-js/utils')
...
export function mergeSchemas (mixin: ServiceSchema, targetSchema: ServiceSchema) : ServiceSchema{
