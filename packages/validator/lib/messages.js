module.exports = {
    ...
    numberMin: `The type of parameter '{param}' have to be boolean.`,
    numberMax: `The type of parameter '{param}' have to be boolean.`,
    numberInteger: `The type of parameter '{param}' have to be boolean.`,
    numberPositive: ``,
    numberNegative: ``,
    object: ``,
    url: ``
